...
msg_err         db 'erreur',0
nom_fenetre     db 'Exemple 2',0
type_bouton     db 'button',0
type_edit       db 'edit',0
bouton_cap      db 'Check serial',0
good_password   dd  094D2374Bh ;MoinsFacile
message_ok      db 'Bienvenue dans MonLogiciel 2.0 !',0
...
crc proc near       ;in:esi-->chaine out:eax=crc
        xor eax,eax             ;calcule le hash
        xor ecx,ecx
t1:     lodsb
        test al,al
        jz t2
